...
% TracŽ du modle exact (trait noir) :
...
d = 6;				% Testez plusieurs valeurs de d entre 2 et 20
lambda = 0.0;			% Testez plusieurs valeurs dans l'intervalle [0,100]

% Estimation des paramtres de la courbe de BŽzier ˆ partir des donnŽes bruitŽes :
